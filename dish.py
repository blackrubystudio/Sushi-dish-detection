"""
Mask R-CNN
Train on the dish dataset.
------------------------------------------------------------
Usage: import the module (see Jupyter notebooks for examples), or run from
       the command line as such:
    # Train a new model starting from pre-trained COCO weights
    python3 dish.py train --dataset=/path/to/dish/dataset --weights=coco
    # Resume training a model that you had trained earlier
    python3 dish.py train --dataset=/path/to/dish/dataset --weights=last
    # Train a new model starting from ImageNet weights
    python3 dish.py train --dataset=/path/to/dish/dataset --weights=imagenet
"""
...
class DishConfig(Config):
    """Configuration for training on the dish dataset.
...
class DishDataset(utils.Dataset):

    def load_dish(self, dataset_dir, subset):
        """Load a subset of the dish dataset.
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        """
        # If not a dish dataset image, delegate to parent class.
            # image_info = self.image_info[image_id]
            # if image_info["source"] != "dish":
